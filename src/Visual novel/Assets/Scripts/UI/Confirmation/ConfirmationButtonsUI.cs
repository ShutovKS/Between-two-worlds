...
namespace UI.Confirmation
{
    public class ConfirmationButtonsUI : MonoBehaviour
    {
        ...
        public void RegisterYesButtonCallback(UnityAction callback) => _yesButton.RegisterNewCallback(callback);
        public void RegisterNoButtonCallback(UnityAction callback) => _noButton.RegisterNewCallback(callback);
    }
}